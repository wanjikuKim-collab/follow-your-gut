      ...
      <div className="hero flex h-full md:flex-row">
        <div className=" hero_content flex flex-col justify-between text-left pl-6 w-1/2">
          ...
          <div className=" flex flex-col justify-center items-left  pt-8 ">
            <h1 className="hero_title text-4xl font-bold text-green-dark font-montserrat mb-4 md:text-7xl">
              {" "}
              <span>Follow</span>
              <br /> Your Gut
            </h1>
        ...
        <div className="hero_image_container w-1/2 flex flex-col items-center justify-center">
          ...
          <div className="w-[600px] h-[500px]">
            <img
              className="hero-image px-2 object-cover rounded-lg flex justify-center size-full"
              src={hero_image}

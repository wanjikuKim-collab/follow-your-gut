  ...
  return (
    <section>
      <div className='hero flex min-h-screen md:flex-row'>
          <div className="hero_content w-1/2 flex flex-col justify-center items-left px-6 pt-8 md:w-1/2 md:px-20">
              <h1 className='hero_title text-4xl font-bold text-green-dark font-montserrat mb-4 md:text-8xl text-left'> <span>Follow</span><br/> Your Gut</h1>

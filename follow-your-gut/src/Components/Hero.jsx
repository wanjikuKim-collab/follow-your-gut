  ...
  return (
    <section>
      <div className='hero flex h-full md:flex-row'>
        ...
        <div className=' hero_content flex flex-col justify-between text-left pl-6 w-1/2'>
          <h3 className='text-green-dark text-base font-semibold py-2'>FYG<br/>Gut health, food and nutrition</h3>
          
          <div className=" flex flex-col justify-center items-left  pt-8 ">
              <h1 className='hero_title text-4xl font-bold text-green-dark font-montserrat mb-4 md:text-7xl'> <span>Follow</span><br/> Your Gut</h1>

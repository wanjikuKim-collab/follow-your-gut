...
function FeatureCard({icon, heading, paragraph,bg_color}) {
  return (
    <div className={`feature_card flex flex-col justify-between items-center rounded-lg p-4 m-2 bg-gray-light hover:bg-gray-dark`}>
        ...
        <p className={`feature_card_about text-green-dark mb-6 tracking-wide text-xl`}>{paragraph}</p>
    </div>
  )
}
